...
<MetaTags
  ...
  openGraph={{
    ...
    title: "Svelte Feathers",
    description: "Feather icon set for Svelte",
    images: [{ url: 'https://open-graph-vercel.vercel.app/api/svelte-feathers', width: 1200, height: 630, alt: "Svelte Feathers" }],
    site_name: 'Svelte Feathers'
  }}
  twitter={{
    handle: '@shinokada',
...
<Footer footerType="logo" class="dark:bg-stone-950">
  ...
  <FooterLinkGroup ulClass="flex flex-wrap items-center mt-3 text-sm text-gray-500 dark:text-gray-400 sm:mt-0">
    ...
    <FooterLink href="https://github.com/shinokada/svelte-feathers/blob/main/LICENSE">Licensing</FooterLink>
